...
# OBS: o zip9- utiliza com parâmetro o menor tamanho em iterável. Isso significa que se estiver trabalhando com
# iteráveis de tamanhos diferentes, irá para quando os elementos
lista3 = [7, 8, 9, 10, 11]
