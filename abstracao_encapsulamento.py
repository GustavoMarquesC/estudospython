...
Esses elementos privado só devem/deveriam ser acessados dentro da classe. Mas Python não bloqueia este acesso fora da
...
Abstração, em POO, é o ato de expor apenas dados relevantes de uma classe, escondendo atriburos e métodos privados de
usuário
...
class Conta:
    ...
    def extrato(self):
        print(f'Saldo de {self.__saldo} do titular {self.__titular} com limte de {self.__limite}')
...
conta1 = Conta('Angelica', 150.00, 1500)
conta1.extrato()
