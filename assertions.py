"""
Assertions (Checagens/Questionamentos) (Asserções) (Afirmações)
...
None e caso seja falsa levanta um erro do tipo AssertionError.
...
Se o programa Python for executado com o parâmetro -o, nenhum assertion será validade. Ou seja, todas as suas validações
já eram.
