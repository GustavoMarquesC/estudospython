...
A função reduce(), funciona da seguinte forma:
    ...
    Passo 2: res1 = f(res1, a3) # Aplica a função passando o resultado do passo1 mais o terceiro elemento e guarda o res
...
Alternativamente, poderámos ver a função reduce() como:
