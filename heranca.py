...
A ideia de herança, é a de reaproveitar código. Também extender nossas clasess.
...
Sobrescrita de Método ocorre quando reescrevemos um método presente na super classe em classes filhas.
"""
