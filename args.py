...
1 - O *args é um parâmetro, como outro qualquer. Isso significa que você poderá chamar de qualquer coisa, desde que come
çe com asterisco.
...
O parâmetro *args utilizado numa função, coloca os valores extras informados como entrada em uma tupla. Então, desde já,
